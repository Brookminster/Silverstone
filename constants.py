...
if test:
    ...
    #State space
    N_TIME_LIMIT = 3000
    N_LANES = 15  #to cope well with the min in optimisation, lane 0 has to be on the inside. This gives a prior on preference
    N_SPEEDS = 25 #39
...
INDEX_SPEED_MULTIPLIER = 4.0 #200 mph is about 90 m/s. We have 20 steps. 

#Motion
def index_to_speed(index): 
    return (index)*INDEX_SPEED_MULTIPLIER+1
# import numpy as np
